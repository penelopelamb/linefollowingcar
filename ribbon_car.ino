...
void loop()
{
  bool atBlackLine = ((sensorValues[0] == sensorValues[1]) && (sensorValues[1] == sensorValues[2])
  ...
  //if at end solid black line
  if (atBlackLine && blackBar == 3)
  {
    //donut
  ...
  //if at solid black line (back at start) then stop
  if (atBlackLine && blackBar == 6)
  {
    while(true)
    {
